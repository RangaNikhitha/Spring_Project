...
public class LoginAspect {
	 ...
	 * ) public void logAfter() { Logger.info("getAllQuestions method executed"); }
	 */
	@AfterReturning("execution(public * com.project.task.controller.TaskController.getAllQuestions())")
	public void logAfter(){ 
	    Logger.info("getAllQuestions method executed"); 
	}
	@AfterThrowing("execution(public * com.project.task.controller.TaskController.getAllQuestions())")
